...
import com.farad.entertainment.kidsanimalenglish.databinding.ItemBigImageGalleryBinding
...
class AdapterBigImageGallery : BaseListAdapter<String, AdapterBigImageGallery.Vh>(DIFF_UTIL) {
    ...
    inner class Vh(val binding: ItemBigImageGalleryBinding) :
        BaseViewHolder<String>(binding.root) {
        override fun bind(obj: String) {
            binding.imageItem.loadImage(obj,true)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Vh {
        return Vh(
            ItemBigImageGalleryBinding.inflate(

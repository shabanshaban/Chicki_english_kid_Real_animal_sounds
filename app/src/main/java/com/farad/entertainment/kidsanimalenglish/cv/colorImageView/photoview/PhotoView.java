...
public class PhotoView extends ImageView implements IPhotoView {
    ...
    private PhotoViewAttacker mAttacher;
    ...
    protected void init() {
        if (null == mAttacher || null == mAttacher.getImageView()) {
            mAttacher = new PhotoViewAttacker(this);
        }
    ...
    @Override
    public PhotoViewAttacker.OnPhotoTapListener getOnPhotoTapListener() {
    ...
    @Override
    public PhotoViewAttacker.OnViewTapListener getOnViewTapListener() {

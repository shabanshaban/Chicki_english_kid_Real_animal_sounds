package com.farad.entertainment.kidsanimalenglish.cv.waveformSeekBar
...
import com.farad.entertainment.kidsanimalenglish.cv.waveformSeekBar.utils.Utils
import com.farad.entertainment.kidsanimalenglish.cv.waveformSeekBar.utils.WaveGravity
import com.farad.entertainment.kidsanimalenglish.cv.waveformSeekBar.utils.WaveformOptions
import java.io.File
...
open class WaveformSeekBar @JvmOverloads constructor(
   ...
   suspend fun setSampleFrom(samples: IntArray) {
        this.sample = samples
    }


  suspend  fun setSampleFrom(audio: File) {
        setSampleFrom(audio.path)
    }


    suspend fun setSampleFrom(audio: String) {
   ...
   suspend fun setSampleFrom(@RawRes audio: Int) {
       try {
           WaveformOptions.getSampleFrom(context, audio) {
               sample = it
           }
   ...
   suspend fun setSampleFrom(audio: Uri) {
        WaveformOptions.getSampleFrom(context, audio) {
            sample = it
        }
    }
